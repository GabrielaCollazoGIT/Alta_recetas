...
namespace RecetasSLN.datos
{
    class RecetasDAO : IRecetasDAO
    {
        public DataTable ListarIngredientes()
        {
            ...
            conexion.ConnectionString = @"Data Source=DESKTOP-LUT25U4\SQLEXPRESS;Initial Catalog=recetas;Integrated Security=True";
            conexion.Open();
        ...
        public int ProximaReceta()
        {
            ...
            SqlConnection conexion = new SqlConnection(@"Data Source=DESKTOP-LUT25U4\SQLEXPRESS;Initial Catalog=recetas;Integrated Security=True");
            SqlCommand comando = new SqlCommand();
            try
            {
